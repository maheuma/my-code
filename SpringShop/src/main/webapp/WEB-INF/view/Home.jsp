...
<h3> Feel Your Favorite Shopping </h3>
  ...
  <ol class="carousel-indicators">
    <li data-target="#myCarousel" data-slide-to="iphon" class="active"></li>
    <li data-target="#myCarousel" data-slide-to="sam" ></li>
    <li data-target="#myCarousel" data-slide-to="htc" ></li>
    <li data-target="#myCarousel" data-slide-to="micr" ></li>
  </ol>
