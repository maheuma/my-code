...
<br>
	...
	<center>
	<div class="container">
	<form:form action="added" method="POST" commandName="product" class="form-horizontal" role="form" enctype="multipart/form-data" >
		
		<div class="form-group">
			<label class=" col-sm-4 control-label">ProductId:</label>
			<div class="col-sm-6">
				<form:input path="id"   placeholder="Enter the id" class="form-control"/>
			</div>
		</div>
		<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<form:input path="price"  class="form-control" required="TRUE" title="should not be empty" />
			</div>
		</div>
			<div class="form-group">
			<label class=" col-sm-4 control-label">ProductCategory:</label>
			<div class="col-sm-6">
		<form:select path="productcategory.name"  items="${categoryList}" itemLabel="name" itemValue="name" class="form-control" required="TRUE" title="should not be empty" />
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<form:select path="productsupplier.name"  class="form-control" items="${supplierList}" itemLabel="name" itemValue="name"  required="TRUE" title="should not be empty" />
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<form:input type="file" path="file"  class="form-control" required="TRUE" />
			</div>
		</div>
